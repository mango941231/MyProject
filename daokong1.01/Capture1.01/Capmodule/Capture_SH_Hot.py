...
class Cap_shhotnews:
    ...
    def capture(self):
        ...
        time.sleep(5)
        driver.save_screenshot('F:\\picture\\souhu\\souhu.png')  # 屏幕截图
        ...
        picture = Image.open('F:\\picture\\souhu\\souhu.png')
        pic = picture.crop((xPiont - 10, yPiont-50, element_width + 20, element_height + 70))
        pic.save(r'F:\\picture\\souhu\\souhu.png')
        """单条评论加上边框"""
