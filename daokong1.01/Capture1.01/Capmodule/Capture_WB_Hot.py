...
class Cap_wbhotnews:
    ...
    def capture(self):
        ...
        driver.get(self.url)
        time.sleep(5)
        driver.save_screenshot('F:\\picture\\weibo\\weibo.png')
        ...
        picture = Image.open('F:\\picture\\weibo\\weibo.png')
        pic = picture.crop((xPiont - 10, yPiontup, element_width+10, element_height))
        pic.save(r'F:\\picture\\weibo\\weibo.png')
        """单条评论加上边框"""
