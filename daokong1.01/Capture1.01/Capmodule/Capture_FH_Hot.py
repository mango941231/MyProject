...
class Cap_fhhotnews:
    ...
    def capture(self):
        ...
        driver.get(self.url)
        time.sleep(5)
        driver.save_screenshot('F:\\picture\\fenghuang\\fenghuang.png')
        ...
        picture = Image.open('F:\\picture\\fenghuang\\fenghuang.png')
        pic = picture.crop((xPiont-10, yPiont, element_width+20, element_height+170))
        pic.save(r'F:\\picture\\fenghuang\\fenghuang.png')
        """单条评论加上边框"""
        ...
        # apiurl = 'http://10.0.6.54/Port/getpic.php'
